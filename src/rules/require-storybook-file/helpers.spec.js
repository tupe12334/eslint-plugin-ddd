...
describe('checkExcludePatterns', () => {
  ...
  it('should match files with **/ pattern', () => {
    expect(checkExcludePatterns('/path/to/index.jsx', ['**/index.jsx'])).toBe(true);
    expect(checkExcludePatterns('\\path\\to\\index.jsx', ['**/index.jsx'])).toBe(true);
    expect(checkExcludePatterns('/path/to/other.jsx', ['**/index.jsx'])).toBe(false);
  });

  it('should match files with simple pattern', () => {
    expect(checkExcludePatterns('/path/examples/file.js', ['/examples/'])).toBe(true);
    expect(checkExcludePatterns('/path/src/file.js', ['/examples/'])).toBe(false);
  });
});
